...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    fheKeys: "Manage homomorphic-encryption runtime keys (skf / dictf / authorization).",
  ...
  login: {
    ...
    failure: {
      ...
      protocol: {
        ...
        stepRestart:
          "Starte das Gateway nach dem Aktualisieren von ClawWorker neu, damit es das aktuelle Protokoll bereitstellt.",
      },
      network: {
